                                ...
                                <div className="box dashboard-main-card primary">
                                    <div className="box-body p-4">
                                        <div className="flex items-start gap-4">
                                            <div className="grow">
                                                <div className="mb-2 text-[12px]">New Users</div> 
                                                <div className="pb-0 mt-0"> 
                                                    <div> 
                                                        <div className="flex items-center gap-2 mb-2!">
                                                            <div className="font-medium fs-24 mb-0!"><span className="count-up" data-count="42">42</span> </div> 
                                                            <span className="badge bg-primary">12,345</span>
                                                        </div>
                                                        <p className="text-textmuted text-[11px] mb-0! leading-none">
                                            ...
                                            <div className="avatar avatar-lg bg-primary-transparent mb-3! svg-primary mx-auto"> 
                            ...
                            <div className="xl:col-span-3 lg:col-span-6 col-span-12">
                                <div className="box dashboard-main-card secondary">
                                    <div className="box-body p-4">
                                        <div className="flex items-start gap-4">
                                            <div className="grow">
                                                <div className="mb-2 text-[12px]">Completed Users</div> 
                                                <div> 
                                                    <div className="flex items-center gap-2 mb-2!">
                                                        <div className="font-medium fs-24 mb-0!"><span className="count-up" data-count="320">320</span></div> 
                                            ...
                                            <div className="avatar avatar-lg bg-secondary-transparent mb-3! svg-secondary mx-auto"> 
                            ...
                            <div className="xl:col-span-3 lg:col-span-6 col-span-12">
                                <div className="box dashboard-main-card success">
                                    <div className="box-body p-4">
                                        <div className="flex items-start gap-4">
                                            <div className="grow">
                                                <div className="mb-2 text-[12px]">Pending Users</div> 
                                                <div> 
                                                    <div className="flex items-center gap-2 mb-2!">
                                                        <div className="font-medium fs-24 mb-0!"><span className="count-up" data-count="81">81</span></div> 
                                            ...
                                            <div className="avatar avatar-lg bg-success-transparent mb-3! svg-success mx-auto"> 
                            ...
                            <div className="xl:col-span-3 lg:col-span-6 col-span-12">
                                <div className="box dashboard-main-card warning">
                                    <div className="box-body p-4">
                                        <div className="flex items-start gap-4">
                                            <div className="grow">
                                                <div className="mb-2 text-[12px]">Inprogress Users</div> 
                                                <div> 
                                                    <div className="flex items-center gap-2 mb-2!">
                                                        <div className="font-medium fs-24 mb-0!"><span className="count-up" data-count="33">33</span>K</div> 
                                                        <span className="badge bg-warning border border-defaultborder">1,105</span>
                                                    </div>    
                                                    <p className="text-textmuted text-[11px] mb-0! leading-none">
                                                        <span className="text-success me-1 font-semibbold">
                                            ...
                                            <div className="avatar avatar-lg bg-warning-transparent mb-3! svg-warning mx-auto"> 
