        ...
        <div className="main-header-container container-fluid px-3">
          <div className="header-content-left">
            ...
            <div className="header-element header-search header-search-content hidden! md:flex!">
              <button
                type="button"
                className="header-search-bar responsive-search disabled:pointer-events-none"
                id="hs-searchOverlay"
                aria-label="Open search1"
                data-hs-overlay="#searchOverlay"
              >
          ...
          <ul className="header-content-right">
            <li className="header-element md:hidden! block!">
              <a
                ...
                className="header-link responsive-search"
                data-hs-overlay="#searchOverlay"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="header-element header-theme-mode items-center!">
                ...
                >
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="lucide lucide-moon-icon lucide-moon header-link-icon"
                  >
                ...
                >
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="lucide lucide-sun-icon lucide-sun header-link-icon"
                  >
            ...
            <li className="header-element notifications-dropdown hidden! xl:flex! relative">
              <a
                ...
                data-hs-overlay="#notification-canvas"
                aria-expanded="false"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <li ref={profileRef} className="header-element ti-dropdown relative profile-header-drop">
              <a
                href="javascript:void(0);"
                className="ti-dropdown-toggle shrink-0"
              ...
              <div
                className={`main-header-dropdown ti-dropdown-menu pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end absolute end-0 top-full z-50${
                  profileOpen ? '' : ' hidden'
                }`}
                role="menu"
              >
                ...
                <ul className="list-unstyled mb-0!">
                  <li>
                    <ul className="list-unstyled mb-0! sub-list">
                      <li>
                        <a className="ti-dropdown-item flex items-center" href="profile.html">
                          <i className="ti ti-user-circle me-2 text-[18px]"></i>View Profile
                        </a>
                      </li>
                      <li>
                        <a className="ti-dropdown-item flex items-center" href="mail-settings.html">
                          <i className="ti ti-settings-cog me-2 text-[18px]"></i>Account Settings
                        </a>
                      </li>
                    </ul>
                  </li>
                    ...
                    <ul className="list-unstyled mb-0! sub-list">
                      <li>
                        <a className="ti-dropdown-item flex items-center" href="javascript:void(0);">
                          <i className="ti ti-lifebuoy me-2 text-[18px]"></i>Support
                        </a>
                      </li>
                      <li>
                        <a className="ti-dropdown-item flex items-center" href="javascript:void(0);">
                          <i className="ti ti-bolt me-2 text-[18px]"></i>Activity Log
                        </a>
                      </li>
                      <li>
                        <a className="ti-dropdown-item flex items-center" href="javascript:void(0);">
                          <i className="ti ti-calendar me-2 text-[18px]"></i>Events
                        </a>
                      </li>
                    </ul>
                  </li>
