(function () {
    ...
    var options = {
        ...
        colors: ["rgba(var(--color-primary-main))", "var(--color-secondary)"],
        dataLabels: {
            enabled: true,
            offsetX: -6,
            style: {
    ...
    var options = {
        ...
        colors: ['rgba(var(--color-primary-main))', 'var(--color-secondary)', 'var(--color-warning)', 'var(--color-success)', '#00c9ff', '#ff6757'],
        grid: {
            borderColor: '#f2f5f7',
        },
        title: {
    ...
    const negativeoptions = {
        ...
        colors: ['var(--color-secondary)','rgba(var(--color-primary-main))'],
        plotOptions: {
            bar: {
                horizontal: true,
                barHeight: '80%',
    ...
    var options = {
        ...
        colors: ['rgba(var(--color-primary-main))', 'var(--color-secondary)', 'var(--color-warning)', 'var(--color-success)', '#00c9ff', '#ff6757', 'rgba(53, 181, 170,1)','rgb(190, 43, 235)',
            "#0cd7b1", "var(--color-secondary)"
        ],
        grid: {
            borderColor: '#f2f5f7',
        },
    ...
    var options = {
        ...
        colors: ['rgba(var(--color-primary-main))', 'var(--color-secondary)', 'var(--color-warning)', 'var(--color-success)'],
        title: {
