...
const button = document.querySelector("#ti-btn"); // ✅ match your HTML button ID
...
// ✅ Validate only when the Validate button is clicked
button.addEventListener("click", () => {
  reset();

  if (!input1.value.trim()) {
    showError("Required");
  } else if (iti.isValidNumber()) { // ✅ use correct method
...
// Reset messages on typing or country change
