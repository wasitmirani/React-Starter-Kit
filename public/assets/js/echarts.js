...
(function () {
    ...
    option = {
        ...
        color: ['#675db0', '#429fd5', '#db991b', '#02bc9c', '#00c9ff', '#ff6757', 'rgba(53, 181, 170,1)',]
    };
    if (option && typeof option === 'object') {
        myChart.setOption(option);
    }
    ...
    option = {
        ...
        color: ["rgb(103, 93, 176)", "rgb(66 ,159, 213)"]
    };
    if (option && typeof option === 'object') {
        myChart.setOption(option);
    }
        ...
        series: [
            {
                ...
                itemStyle: {
                    shadowBlur: 10,
                    shadowColor: 'rgba(103, 93, 176, 0.5)',
                    shadowOffsetY: 5,
            ...
            },
            {
                ...
                itemStyle: {
                    shadowBlur: 10,
                    shadowColor: 'rgba(66 ,159, 213, 0.5)',
                    shadowOffsetY: 5,
                    color: new echarts.graphic.RadialGradient(0.4, 0.3, 1, [
                        {
                            offset: 0,
        ...
        series: [
            {
                ...
                itemStyle: {
                    normal: {
                        color: "rgb(103, 93, 176)",
                        color0: "rgb(66 ,159, 213)",
                        borderColor: "rgb(103, 93, 176)",
                        borderColor0: "rgb(66 ,159, 213)",
                    }
                }
            }
        ]
