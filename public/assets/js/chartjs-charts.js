(function () {
    ...
    const data = {
        ...
        datasets: [{
            ...
            backgroundColor: 'rgb(103, 93, 176)',
            borderColor: 'rgb(103, 93, 176)',
    ...
    const data4 = {
        ...
        datasets: [{
            ...
            data: [10, 20, 30, 40],
            borderColor: 'rgb(103, 93, 176)',
            backgroundColor: 'rgba(103, 93, 176, 0.2)'
        }, {
            type: 'line',
            label: 'Line Dataset',
            data: [50, 50, 50, 50],
            fill: false,
            borderColor: 'rgb(66, 159, 213)'
        }]
    };
    const config5 = {
        type: 'scatter',
    ...
    const data6 = {
        ...
        datasets: [{
            ...
            backgroundColor: 'rgba(103, 93, 176, 0.2)',
            borderColor: 'rgb(103, 93, 176)',
            pointBackgroundColor: 'rgb(103, 93, 176)',
            pointBorderColor: '#fff',
            pointHoverBackgroundColor: '#fff',
            pointHoverBorderColor: 'rgb(103, 93, 176)'
        }, {
            label: 'My Second Dataset',
            data: [28, 48, 40, 19, 96, 27, 100],
            fill: true,
            backgroundColor: 'rgba(66, 159, 213, 0.2)',
            borderColor: 'rgb(66, 159, 213)',
            pointBackgroundColor: 'rgb(66, 159, 213)',
            pointBorderColor: '#fff',
            pointHoverBackgroundColor: '#fff',
            pointHoverBorderColor: 'rgb(66, 159, 213)'
        }]
    };
    const config7 = {
        type: 'radar',
