(function () {
  ...
  $(".js-example-templating").select2({
      ...
      templateSelection: formatState1, // Use the same format for the selected option,
      placeholder: "Choose Customer",
      dir: "rtl"
  });
  ...
  /* with images */
  $(".select2-client-search").select2({
      templateResult: selectClient1,
      templateSelection: selectClient1,
      placeholder: "Choose Client",
      dir: "rtl",
//       escapeMarkup: function (m) { return m; }
  });
  ...
  document.querySelector("#switcher-ltr").addEventListener("click",()=>{
      ...
      $(".js-example-templating").select2({
            ...
            templateSelection: formatState2, // Use the same format for the selected option,
            placeholder: "Choose Customer",
          dir: "ltr"
      });
      $(".select2-client-search").select2({
        templateResult: selectClient2,
        templateSelection: selectClient2,
        placeholder: "Choose Client",
          dir: "ltr",
      });
      /* max selections limiting */
   ...
   document.querySelector("#reset-all").addEventListener("click",()=>{
    ...
    $(".js-example-templating").select2({
        ...
        templateSelection: formatState3, // Use the same format for the selected option,
        placeholder: "Choose Customer",
        dir: "ltr"
    });
    $(".select2-client-search").select2({
        templateResult: selectClient3,
        templateSelection: selectClient3,
        placeholder: "Choose Client",
        dir: "ltr",
    });
    /* max selections limiting */
